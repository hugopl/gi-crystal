...
module GICrystal
  ...
  # All objects (in gobject introspection terms, i.e. things represented by GObjectInfo) types created by GICrytal includes
  # that. So it's easy to know if an Object isn't related to any GICrystal generated binding.
